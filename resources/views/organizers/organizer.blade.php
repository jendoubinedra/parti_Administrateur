        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Ajouter organizer</h3>
                    </div>
                </div>
            </div>
            ...
            <div id="modalBackgroundAdd" style="display: none; position: fixed; top: 0; left: 0; width: 120%; height: 120%; background-color: rgba(0,0,0,0.5);">
                <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 40px;width: 40%; text-align: center; font-size: 16px;">
                    ...
                    <form action="organizer" method="post" id="linkForm"  enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <div class="form-group">
                            <label for="name">src:</label>
                            <input id="src" type="file" class="form-control @error('src') is-invalid @enderror" name="src" value="" required autocomplete="nom" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="name">alt:</label>
                            <input id="alt" type="text" class="form-control @error('alt') is-invalid @enderror" name="alt" value="" required autocomplete="nom" autofocus>
                        </div>
                        <div class="form-group">
                            <label for="name">order :</label>
                            <input id="order" type="text" class="form-control @error('order') is-invalid @enderror" name="order" value="" required autocomplete="nom" autofocus>
                        </div>
                     <button type="submit" class="btn btn-primary buttonedit ml-2">Add organizer</button>
                    </form>
