        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Ajouter keynote</h3>
                    </div>
                </div>
            </div>
                ...
                <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 40px;width: 40%; text-align: center; font-size: 16px;">
                    ...
                    <form action="keynote" method="post" id="linkForm">
                        ...
                        <div class="form-group">
                            ...
                            <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="" required autocomplete="nom" autofocus>
                        </div>
                        <button type="submit" class="btn btn-primary buttonedit ml-2">Add speaker</button>
                    </form>
